...
export default function SellerOrders() {
  ...
  return (
    <div className="min-h-screen bg-slate-50/50 dark:bg-black max-w-md mx-auto">
      ...
      <div className="max-w-md mx-auto px-4 py-20 space-y-8 pb-32">
        <motion.div
        ...
        >
          ...
          <div className="relative z-10 space-y-2">
            <h2 className="text-3xl font-black tracking-tighter italic uppercase">
              {t("ordersManagementSoon")}
            </h2>
            <p className="text-muted-foreground font-medium max-w-sm mx-auto">
              We're currently building a powerful order management system to
              help you track and fulfill customer requests with ease.
            </p>
          </div>
