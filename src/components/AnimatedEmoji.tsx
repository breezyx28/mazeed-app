...
export const AnimatedEmoji: React.FC<AnimatedEmojiProps> = ({ 
  ...
  // Only attempt to show GIF if hovered and it hasn't failed before
  const showGif = isHovered && !hasGifError;
  ...
  return (
    ...
    >
      <img
        ...
        // Otherwise use static as default and switch to GIF on hover
