...
const resources = {
  ar: {
    translation: {
      ...
      biometricNotAvailableNative:
        "المصادقة البيومترية متاحة فقط على الأجهزة الأصلية",
      ...
      noSavedCredentials:
        "لم يتم العثور على بيانات اعتماد محفوظة. يرجى تسجيل الدخول بكلمة المرور أولاً.",
      ...
      testNotificationMessage:
        "هذا إشعار تجريبي للتحقق من وظائف الصوت والشارة.",
      ...
      sellerDashboardDevMessage:
        "هذه الميزة قيد التطوير. قريباً ستتمكن من إدارة المنتجات والطلبات هنا.",
      ...
      newOfferTypePlaceholder: "Example: Friday White",
      newOfferTypePlaceholderAr: "مثال: الجمعة البيضاء",
      create: "إنشاء",
      ...
      mainVisual: "الصورة الرئيسية",
      coreDetails: "التفاصيل الأساسية",
      fulfillmentPromos: "التوصيل والعروض",
      additionalAssets: "ملفات إضافية",
      colorsSizesTags: "الألوان والمقاسات والشارات",
      addColor: "إضافة لون",
      imagePreview: "معاينة الصورة",
      changeImage: "تغيير الصورة",
      uploadImage: "رفع صورة",
      productReel: "فيديو المنتج",
      clickToChange: "انقر للتغيير",
      videoUploadHint: "MP4 / WEBM (الحد الأقصى 50MB)",
      materialExample: "مثال: قطن",
      almostReady: "هل أنت جاهز؟",
      almostReadyDesc:
        "راجع المخزون والتسعير. عند النشر، سيظهر منتجك للعملاء في الخرطوم.",
      pleaseSaveProductFirst: "يرجى حفظ المنتج أولاً",
      ...
      notDeliverableMessage:
        "هذا المنتج غير قابل للتوصيل حالياً. يمكنك التوجه إلى المتجر لاستلامه بنفسك.",
      ...
      reportHelpDesc:
        "ساعدنا في الحفاظ على دقة المعلومات من خلال الإبلاغ عن مشاكل المنتج.",
      sales: "المبيعات",
      ...
      nearbyProducts: {
        ...
        enableLocationDesc:
          "شاهد المنتجات المتوفرة في المتاجر القريبة من موقعك الحالي في الخرطوم.",
        ...
        locationRequiredDesc:
          "لتزويدك باتجاهات المشي، يرجى تفعيل أذونات الموقع في متصفحك أو إعدادات الجهاز.",
  ...
  en: {
    translation: {
      ...
      biometricTestingNative:
        "Biometric testing is only available on native devices",
      fingerprintNotAvailableDevice:
      ...
      testNotificationMessage:
        "This is a test notification to verify sound and badge functionality.",
      ...
      sellerProfileUnderReview:
        "Your seller account is currently under review.",
      myShop: "My Shop",
      becomeASellerTitle: "Become a Seller",
      becomeASellerSubtitle:
        "Start your selling journey on Mazeed Store today.",
      shopName: "Shop Name",
      ...
      notDeliverableMessage:
        "This product is currently not deliverable. You must visit the store to pick it up.",
      ...
      reportHelpDesc:
        "Help us keep the marketplace accurate by reporting product issues.",
      sales: "Sales",
      ...
      sellerDashboardDevMessage:
        "This feature is under development. Soon you'll be able to manage products and orders here.",
      ...
      newOfferTypePlaceholderAr: "e.g. Black Friday",
      create: "Create",
      ...
      fulfillmentPromos: "FULFILLMENT & PROMOS",
      additionalAssets: "ADDITIONAL ASSETS",
      colorsSizesTags: "COLORS, SIZES & TAGS",
      addColor: "ADD COLOR",
      imagePreview: "Image preview",
      changeImage: "Change Image",
      uploadImage: "Upload Image",
      productReel: "Product Reel",
      clickToChange: "Click to change",
      videoUploadHint: "MP4 / WEBM (MAX 50MB)",
      materialExample: "e.g. Cotton",
      almostReady: "Almost Ready?",
      almostReadyDesc:
        "Double check your inventory and pricing. Once published, your product will be live for customers across Khartoum.",
      pleaseSaveProductFirst: "Please save the product first",
      ...
      nearbyProducts: {
        ...
        discoverDesc:
          "See what products are available in stores around you right now.",
        enableButton: "Enable Location",
        enableLocationTitle: "Find Local Products",
        enableLocationDesc:
          "See products available in physical stores near your current location in Khartoum.",
        ...
        noResultsDesc:
          "Try expanding your search or choosing another category.",
        ...
        locationRequiredDesc:
          "To provide walking directions, please enable location permissions in your browser or device settings.",
